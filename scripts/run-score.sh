...
python3 "$ROOT_DIR/skills/execution-ledger/scripts/execution-ledger.py" record --kind system-run --title "Score refresh" --status done --area executive-control --project rick-v6 --route strategy --notes "Portfolio ranking regenerated and scoreboard refreshed." >/dev/null
