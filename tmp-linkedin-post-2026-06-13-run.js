...
const PORT = 9225;
const USER_DATA_DIR = '/tmp/chrome-linkedin';
...
async function main() {
  try { spawn(CHROME, ['--remote-debugging-port=9225', `--user-data-dir=${USER_DATA_DIR}`, 'about:blank'], { detached: true, stdio: 'ignore' }).unref(); } catch {}
